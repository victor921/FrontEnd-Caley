...
export default {
  ...
  try {
    ...
    const accountURL = "https://strgaccouncentralus1.blob.core.windows.net";
    const containerName = "caley-operations-dev";
    const sasToken = "sv=2022-11-02&ss=bfqt&srt=sco&sp=rwdlacupiytfx&se=2026-12-03T00:40:02Z&st=2024-12-02T16:40:02Z&spr=https,http&sig=Lwe6NvPkSnmhU1H3pnkNv1rrQFnJzVLfYkqRWJi%2F5Kg%3D"; // Replace with your SAS token
